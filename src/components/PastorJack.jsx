...
export default function PastorJack() {
  ...
  subheader='October 7th, 1940 - February 29th, 2004'
  />
      ...
      <p className='scripture'>Pastor at Grace Fellowship from 1993-2004<br />Pastor Jack went to be with the Lord suddenly in February 2004.</p>
