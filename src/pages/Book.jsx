...
export default function Book() {
  ...
  return (
    <Box flex={5} p={1}>
      <Card
        sx={{ position: 'fixed', top: 48, left: 0, right: 0, zIndex: 1 }}
        elevation={3}
      >
            ...
            <Card sx={{ zIndex: 1 }}>
              <CardHeader
                avatar={
                  <Avatar
                    sx={{ bgcolor: 'teal' }}
                    aria-label="Grace Fellowship of Mountain Home Idaho"
                  >
                    GF
                  </Avatar>
                }
                ...
                <List>
                  <ListItem dense={true}>
                    <Button
                      ...
                      download={sermon.path + sermon.pdf}
                    >
                  ...
                  <ListItem dense={true}>
                    <Button
                      href={sermon.path + sermon.jpg}
                      download={sermon.path + sermon.jpg}
                    >
